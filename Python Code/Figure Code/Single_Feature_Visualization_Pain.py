...
log_filename = in_path + "pain_logisitic_pe_theta.csv"
log_model_weights = pd.read_csv(log_filename)
log_model_weights = log_model_weights.multiply(100)

svm_filename = in_path + "pain_svm_pe_theta.csv"
...
plt.savefig(in_path + 'pain_logistic_topomap.png')

#topomap = plt.imread(in_path + 'pain_logistic_topomap.png')
...
plt.savefig(in_path + 'pain_logistic_barchart.png')

#bar_graph = plt.imread(in_path + 'pain_logistic_barchart.png')
...
cbar_ax = fig.add_axes([ax_x_start, ax_y_start, ax_x_width, ax_y_height])
clb = fig.colorbar(im, cax=cbar_ax)
plt.savefig(in_path + 'pain_svm_topomap.png')

#topomap = plt.imread(in_path + 'pain_svm_topomap.png')
...
plt.ylabel('Classification Accuracy (%)', fontweight='bold')
ax.axis(ymin=40,ymax=80)
plt.savefig(in_path + 'pain_svm_barchart.png')

#bar_graph = plt.imread(in_path + 'pain_svm_barchart.png')
