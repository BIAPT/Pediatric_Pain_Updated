...
Line by line annotation can be found in "Single_Feature_Accuracy_Cold_Control_COVAS" for more details"""
...
for i in range(n):
    ...
    pipe.fit(X_train_electrode, y_train) #fit model (that is specified in gridsearch function below)/learn data using the training sets
...
accuracy_df.columns = df_headers
accuracy_df['All'] = all_accuracy

filename = out_path + 'pain_logisitic_pe_theta.csv'
...
filename = out_path + 'pain_svm_pe_theta.csv'
