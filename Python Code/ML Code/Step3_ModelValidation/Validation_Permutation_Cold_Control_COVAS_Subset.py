...
X_train, y_train, group_train, df_train = pre_process_acute_pain_baseline_vs_cold_control_subset(df_train)
X_valid, y_valid, group_valid, df_valid = pre_process_acute_pain_baseline_vs_cold_control_subset(df_valid)
...
permutation_df.to_csv(out_path + 'cold_control_logistic_dpli_permutation.csv')
...
permutation_df = permutation_df.rename(columns={0: "Random Accuracy"})
permutation_df.to_csv(out_path + 'cold_control_svm_dpli_permutation.csv')
