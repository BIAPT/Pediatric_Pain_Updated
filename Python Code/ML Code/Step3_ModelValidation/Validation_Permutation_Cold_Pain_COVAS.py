...
X_train, y_train, group_train, df_train = pre_process_acute_pain_baseline_vs_cold_pain(training_filename)
X_valid, y_valid, group_valid, df_valid = pre_process_acute_pain_baseline_vs_cold_pain(validation_filename)
...
permutation_df.to_csv(out_path + 'cold_pain_logistic_all_permutation.csv')
...
permutation_df = permutation_df.rename(columns={0: "Random Accuracy"})
permutation_df.to_csv(out_path + 'cold_pain_svm_all_permutation.csv')
