...
df = pd.read_csv(filename) # load the full dataframe
...
# create X dataframe with EEG feature of interest
...
control_perform_filename_log = out_path + f"cold_control_best_logistic_dpli.pickle"
...
# SVM Models- Controls
control_perform_filename_svm = out_path + f"cold_control_best_svm_dpli.pickle"
