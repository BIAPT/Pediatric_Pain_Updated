...
# In lines 33-36, only the one variable of interest should be greyed out
...
permutation_filename = out_path + "cold_pain_logisitic_permutation_dpli.csv"
...
X, y, group, df = pre_process_acute_pain_baseline_vs_cold_pain_subset(input_file)
...
# SVM Models- Controls
permutation_filename = out_path + "cold_pain_svm_permutation_dpli.csv"
